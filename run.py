...
def update_worksheet(data, worksheet):
    ...
    print(f'{worksheet.capitalize()} worksheet update successfully...\n')


def calculate_surplus_data(sales_row):
    """
    Compare sales with sotck and calculate the surplus for each item type.
...
def get_last_5_entries_sales():
    """
    Collects columns of data drom sales worksheet, collecting
    the last 5 entreis for each sandwich and return the data
    as a list of lists.
    """
